...
-- Diagnostic keymaps
Map('n', '<C-[>', vim.diagnostic.goto_prev, { desc = 'Go to previous [D]iagnostic message' })
Map('n', '<C-]>', vim.diagnostic.goto_next, { desc = 'Go to next [D]iagnostic message' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      Map('n', '<leader>.h', builtin.help_tags, { desc = '[S]earch [H]elp' })
      Map('n', '<leader>.k', builtin.keymaps, { desc = '[S]earch [K]eymaps' })
      Map('n', '<leader>.f', builtin.find_files, { desc = '[S]earch [F]iles' })
      Map('n', '<leader>.s', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
      Map('n', '<leader>.w', builtin.grep_string, { desc = '[S]earch current [W]ord' })
      Map('n', '<leader>.g', builtin.live_grep, { desc = '[S]earch by [G]rep' })
      Map('n', '<leader>.d', builtin.diagnostics, { desc = '[S]earch [D]iagnostics' })
      Map('n', '<leader>.r', builtin.resume, { desc = '[S]earch [R]esume' })
      Map('n', '<leader>..', builtin.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
      Map('n', '<leader>.R', builtin.registers, { desc = '[S]earch [R]egisters' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<M-h>', vim.lsp.buf.hover, 'Hover Documentation')
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      Cmd.colorscheme 'solarized-osaka-night'
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'python', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'javascript', 'typescript', 'tsx' },
